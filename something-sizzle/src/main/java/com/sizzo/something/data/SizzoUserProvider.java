...
public class SizzoUserProvider extends ContentProvider {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
	        ...
	        //User2User table
	        db.execSQL("CREATE TABLE IF  NOT EXISTS user2user" + 
	...
	public Uri upsert(Uri uri,ContentValues values){
		return null;
	}
	public ContentValues findByUid(Uri uri,String uid){
		return null;
	}
}
