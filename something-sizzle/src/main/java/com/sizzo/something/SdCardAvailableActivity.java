...
public class SdCardAvailableActivity extends Activity
{
    @Override
    ...
    public static void show(Context context) {
        final Intent intent = new Intent(context, SdCardAvailableActivity.class);
    ...
    public void doRetry(View v) {
        ...
        Toast.makeText(this,R.string.sd_not_available,Toast.LENGTH_LONG);
        refreshSDState();
    }
